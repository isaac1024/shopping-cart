...
class NegativeProductPriceException extends ShoppingCartException
{
    ...
    public static function negativePrice(): NegativeProductPriceException
    {
        return new NegativeProductPriceException(self::NEGATIVE_PRICE_ERROR, self::NEGATIVE_PRICE_MESSAGE);
    }
}

...
final class RepositoryModelComparator extends Comparator
{
    private const IGNORE_PROPERTIES =  ['createdAt', 'updatedAt'];

    public function accepts($expected, $actual): bool
    {
        return $expected instanceof RepositoryModel && $actual instanceof RepositoryModel;
    }
